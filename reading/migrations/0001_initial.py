# Generated by Django 3.1.3 on 2021-01-01 23:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('url', models.URLField(blank=True, default=None, help_text="The source of the article (will be empty if private source isn't)", null=True)),
            ...
            managers=[
                ('instapaper', django.db.models.manager.Manager()),
            ],
        ),
    ]
