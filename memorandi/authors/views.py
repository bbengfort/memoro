# memorandi.authors.views
# Class based Auth views and profile views
#
# Author:   Benjamin Bengfort <benjamin@bengfort.com>
# Created:  Sat Feb 15 20:36:09 2014 -0500
#
...
class ProfileView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['author'] = Author.fromUser(self.request.user)
        return context
...
class ChangePasswordView(LoginRequiredMixin, FormView):
    ...
    template_name = "authors/change-password.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        context['student'] = Author.fromUser(self.request.user)
        return context
...
class PasswordResetView(DispatchProtectionMixin, FormView):
    ...
    template_name    = "authors/password-reset.html"
...
class PasswordResetConfirmView(DispatchProtectionMixin, FormView):
    ...
    def check_link(self, uidb36, token):
        ...
        try:
            ...
            self.user = Author.objects.get(id=uid_int)
        except (ValueError, OverflowError, Author.DoesNotExist):
            self.user = None
...
class PasswordResetCompleteView(TemplateView):
    ...
    template_name = "authors/password-reset-complete.html"
